...
engine logic: it calls `agent_compose.compose.run` directly.
"""
...
from agent_compose.cli.run import run as _run
...
def main() -> None:
    """Console-script entry point (`ac = agent_compose.cli:main`)."""
    app()
