...
from agent_compose.compile.expand import clone_child, clone_continuation_pair, map_callsite, ns
from agent_compose.compile.model import END_ID, START_ID, CompiledFlow, Edge, NodeState
from agent_compose.nodes.end import EndNode
from agent_compose.nodes.base import NodeKind
from agent_compose.runtime.eval_node import _SPAWNER_KINDS, eval_node
from agent_compose.runtime.state_manager import StateManager
from agent_compose.state import SegmentError
...
def _append_child(parent, child) -> None:
    ...
    """
    from agent_compose.suspension.expansions import AgentExpansion  # lazy
