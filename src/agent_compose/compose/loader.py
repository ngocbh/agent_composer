...
from agent_compose.state.segments import SegmentError, Shape
...
from agent_compose.compose.calls import _synth_id_gen, desugar_inline_calls
...
from agent_compose.compose.uses import parse_uses_ref
